...
(function () {
  ...
  function load() {
    ...
    fetch(SB + '/rest/v1/comments?url=eq.' + encodeURIComponent(PATH) + '&select=id,pid,nick,email,is_admin,pinned,content,created_at&order=created_at.desc', { headers: headers() })
